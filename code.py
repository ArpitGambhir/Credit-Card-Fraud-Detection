...
c = b.sample(n=9508, random_state=5)        # Choosing random 9508 values from the DataFrame with only 0 values
d = [a, c]
e = pd.concat(d)            # Concatinating the 2 matrices a and c
...
clf = SVC(C=1, degree=3, max_iter=100)
